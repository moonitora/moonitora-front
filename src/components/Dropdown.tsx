                ...
                <li>
                    ...
                    <div className={`${isActive ? "visible" : "invisible"} flex flex-col`}>
                        {options.map((element, index) => {
                            return (
                                <div className={`${index == options.length - 1 ? "border-b-[1px] rounded-bl-md rounded-br-md" : ""} ${isActive? "cursor-pointer" : ""} p-2 bg-white w-72 border-l-[1px] border-r-[1px] border-moonitora-cyan "hover:border-l-4 hover:bg-gray-50`} onClick={() => handleClick(element)}>
